...
export default function Create({ dataKelas }: any) {
  const { props } = usePage()
  ...
  return (
    <div className="max-w-6xl mx-auto lg:p-6">
      <Notification />
      <h1 className="text-2xl font-bold text-gray-900 dark:text-white mb-6">Tambah Jurusan Baru</h1>
      <Form kelasOption={kelas} onSubmit={handleSubmit} submitLabel="Simpan" />
    </div>
  )
}
