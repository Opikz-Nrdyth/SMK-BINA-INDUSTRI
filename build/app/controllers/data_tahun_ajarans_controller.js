...
export default class DataTahunAjaransController {
    async index({ request, inertia, session }) {
        ...
        const data = tahunAjarans.map((item) => ({
            ...item,
        ...
        return inertia.render('TahunAjaran/Index', {
            tahunAjaranPaginate: {
                ...
                firstPage: 1,
                nextPage: tahunAjaranPaginate.currentPage < tahunAjaranPaginate.lastPage
                    ? tahunAjaranPaginate.currentPage + 1
                    : null,
                previousPage: tahunAjaranPaginate.currentPage > 1 ? tahunAjaranPaginate.currentPage - 1 : null,
            },
            tahunAjarans: data,
